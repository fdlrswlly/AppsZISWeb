...
<title>Edit Data Bank Yayasan</title>
<!-- Font Awesome -->
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form action="<?php echo base_url() ?>/DataBank/simpan" method="post" enctype="multipart/form-data">
                        <input type="hidden" id="text-input" name="id_bank" placeholder="" class="form-control" value="<?php echo $x['id_bank']; ?>">
                        <!--<div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="text-input" name="nama_bank" placeholder="Masukkan Nama Bank" class="form-control" value="<?php echo $x['nama_bank']; ?>">
                        </div>
                        <div class="form-group">
                            <label>No.Rekening <span class="required">*</span></label>
                            <input type="text" id="text-input" name="no_rekening" placeholder="Masukkan No. Rekening" class="form-control" value="<?php echo $x['no_rekening']; ?>">
                        </div>
                        <div class="form-group">
